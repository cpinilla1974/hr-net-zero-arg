...
|----------|---------------------------|-------------------|------------|
| Caliza | `Limestone, crushed, for mill, market for` | GLO/RER/América Latina | Si Yura-2c |
| Arcilla | `Clay, market for` | GLO/RER | Si Yura-2c |
...
| Material | Process Name en Ecoinvent | Ubicación sugerida | Uso actual |
|----------|---------------------------|-------------------|------------|
| Escoria de alto horno | `Slag, from blast furnace, market for` | GLO/EUR | Si 3c |
| Ceniza volante | `Fly ash, market for` | GLO | Si 3c |
| Yeso | `Gypsum, mineral, market for` o `Gypsum plasterboard, production` | GLO/RER | Si Yura-2c |
...
| Combustible | Process Name en Ecoinvent | Ubicación | Uso actual |
|-------------|---------------------------|-----------|------------|
| Aceite usado (waste oil) | `Waste lubricating oil, market for` | RER/GLO | Si Yura-2c |
| Neumáticos (tyres) | `Tire, passenger car, end of life` | GLO | Si Yura-2c |
| RDF incluyendo plásticos | `Municipal solid waste, 22.9% water, to sanitary landfill` o similar | GLO/LAC | Si Yura-2c |
...
| Combustible | Process Name en Ecoinvent | Ubicación | Uso actual |
|-------------|---------------------------|-----------|------------|
| Lodos de depuradora secos (dried sewage sludge) | `Sewage sludge, dried, market for` | GLO/RER | Si Yura-2c |
| Madera no impregnada / aserrín | `Wood chips, softwood, forest, u=70%, market for` | GLO/LAC | Si Yura-2c |
| Papel y cartón | `Waste paper, unsorted, market for waste paper` | GLO | Si Yura-2c |
...
| Residuos agrícolas | `Rice straw, field` o similar | LAC/Asia | Si Requerido |
| Residuos forestales | `Wood chips, softwood, forest` | LAC | Si Requerido |
| RSU fracción orgánica | `Biowaste, market for` | GLO/LAC | Si Requerido |
...
|----------|---------------------------|-----|-------|
| Captura de metano de rellenos sanitarios | `Methane, from landfill gas` (avoided) | Si E07 | Crédito negativo por evitar metano a atmósfera |
| Digestión anaeróbica RSU | `Biogas, from biowaste, at anaerobic digestion plant` | Si E07 | Valorización energética con captura |
...
|------|---------------------------|------------|
| Camión >32t (EURO4) | `Transport, freight, lorry >32 metric ton, EURO4, market for` | Si Todos |
...
|----------|---------------------------|------------|
| Arena natural | `Sand, market for` o similar | Si 3c |
| Grava | `Gravel, crushed, market for` | Si 3c |
| Gravilla | Similar a grava | Si 3c |
...
|---------|---------------------------|------------|
| Electricidad red Argentina | `Electricity, medium voltage, market for` (Argentina) | Si Todos |
| Electricidad red Chile | `Electricity, medium voltage, market for` (Chile) | Si 3c |
| Agua industrial | `Tap water, at user` | Si Todos |
...
3. Pendiente Validar lista con Francisco Vidal (vidal@ecoinvent.org)
4. Pendiente Solicitar cotización Developer License
5. Pendiente Definir número final de usuarios y datasets
6. Pendiente Negociar contrato anual
