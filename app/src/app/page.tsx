      ...
      <section className="relative bg-gradient-to-br from-[#1B3A5F] via-[#2E5A8B] to-[#1B3A5F] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-8 pt-12 pb-8">
          ...
          <div className="flex justify-end mb-4">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-white px-4 py-1.5 rounded-full text-xs font-medium border border-white/20 backdrop-blur-sm">
              Versión 2.1 (Oct 2023)
            </div>
          </div>
          ...
          <header className="mb-8">
            <div className="flex items-start justify-between mb-3">
              <h2 className="text-primary-dark text-4xl font-extrabold leading-tight tracking-tight max-w-3xl text-white">
                Net Zero Argentina 2050
                <br />
                <span className="text-white/80 font-bold text-3xl">
                  Crecimiento y Cero Emisiones
                </span>{" "}
                en Cemento
              </h2>
            </div>
            <p className="text-white/70 text-lg max-w-2xl mt-4 font-light">
              Visualización estratégica del compromiso dual del sector para las próximas tres décadas.
            </p>
          </header>
